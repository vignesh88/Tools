...
#SECRET_KEY = '564)v7c4i3!_7jfqewh$)wx%9$$e0lfg0-lep6zq#y9bj1@b=l'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'app_general/static_files'),
    os.path.join(BASE_DIR, 'app_base64/static_files'), 
